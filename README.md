...
task: [cert:init] mkcert -cert-file etc/traefik/certs/dev-tools.pem --key-file etc/traefik/certs/dev-tools-key.pem "*${BASE_HOSTNAME}"
...
task: [add-hostname 'foo'] sudo sh -c 'echo "127.0.0.1   foo$BASE_HOSTNAME     # Added by dev-tools" >> C:/Windows/System32/drivers/etc/hosts'
